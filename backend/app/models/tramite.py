...
class Tramite(Base):
    ...
    dirigido_a: Mapped[str | None] = mapped_column(Text, nullable=True)
    pasos: Mapped[str | None] = mapped_column(Text, nullable=True)
    tiempo_estimado: Mapped[str | None] = mapped_column(Text, nullable=True)
    medio_seguimiento: Mapped[str | None] = mapped_column(Text, nullable=True)
    normatividad: Mapped[str | None] = mapped_column(Text, nullable=True)
    ...
    enlace_click_aqui: Mapped[str | None] = mapped_column(String(500), nullable=True)
